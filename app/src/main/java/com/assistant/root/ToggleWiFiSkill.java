...
public class ToggleWiFiSkill implements Skill {
    ...
    public boolean matches(String normalizedCommand) {
        return normalizedCommand.contains("wifi") && (normalizedCommand.contains("toggle") || normalizedCommand.contains("turn") || normalizedCommand.contains("enable") || normalizedCommand.contains("disable") || normalizedCommand.contains("on") || normalizedCommand.contains("off"));
    }
    ...
    public void execute(String normalizedCommand, CommandExecutor executor) {
        ...
        if (normalizedCommand.contains("off") || normalizedCommand.contains("disable")) enable = false;
